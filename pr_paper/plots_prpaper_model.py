...
fev_stack_plot = fev_stack_plot.T
idx_cells_valid_val_cnn = np.logical_and(fev_stack_plot>-110,fev_stack_plot<110)
fev_clean_val_cnn = fev_stack_plot.copy()
...
fev_stack_plot = fev_stack[1:]*100
fev_stack_plot = fev_stack_plot.T
idx_cells_valid_val_pr = np.logical_and(fev_stack_plot>-110,fev_stack_plot<110)
fev_clean_val_pr = fev_stack_plot.copy()
...
axs[0].text(0.15,-100,'N = %d RGCs' %fev_stack_plot.shape[0],fontsize=font_size_ticks)
...
# ---- WITH PR ----#
exp_select = 'retina2'
path_exp = '/home/saad/data/analyses/data_kiersten/data_cshl/'+exp_select       # 8ms_resamp folder in retina2
...
# ---- WITHOUT PR ----#
path_exp = '/home/saad/data/analyses/data_kiersten/'+exp_select+'/8ms_noPR'
mdl_params = 'U-0.00_T-120_C1-20-03_C2-24-02_C3-22-01_BN-1_MP-0_TR-01'
