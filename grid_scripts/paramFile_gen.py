...
datasetName = 'photopic-10000'    # ['scotopic','photopic','scotopic_photopic','photopic_shiftedPhotopic']
...
filt1_3rdDim = np.atleast_1d((20)) #np.atleast_1d((1,10,20,30,40,50,60))
...
filt2_3rdDim = np.atleast_1d((55)) #np.atleast_1d((1,8,10,12,14,18,20,30,40,50))
...
filt3_3rdDim = np.atleast_1d((47))#np.atleast_1d((1,8,10,12,14,18,20,30,40,50))
