...
expDate = 'retina1'
subfold = '8ms_TRSAMPS'
datasetName = 'photopic-10000_preproc-added_norm-1_rfac-2'    # ['scotopic','photopic','scotopic_photopic','photopic_shiftedPhotopic']
...
csv_header = ['expDate','mdl_name','path_model_save_base','name_datasetFile','thresh_rr','temp_width','bz_ms','nc_epochs','chan1_n','filt1_size','filt1_3rdDim','chan2_n','filt2_size','filt2_3rdDim','chan3_n','filt3_size','filt3_3rdDim','BatchNorm','MaxPool','num_trials','USE_CHUNKER','TRSAMPS']
...
for i in range(params_array.shape[0]):
    ...
    csv_data = [expDate,mdl_name,path_model_save_base,fname_data_train_val_test,thresh_rr,temporal_width,bz_ms,nb_epochs]
    csv_data.extend(rgb)
