...
path_mdl = '/home/sidrees/scratch/RetinaPredictors/data/retina2/8ms/photopic-10000_preproc-added_norm-1_rfac-2/CNN_2D/U-0.00_T-120_C1-13-03_C2-26-02_C3-24-01_BN-1_MP-0_TR-01/'
trainingDataset = '/home/sidrees/scratch/RetinaPredictors/data/retina2/8ms/datasets/retina2_dataset_train_val_test_photopic-10000_preproc-added_norm-1_rfac-2.h5'
testingDataset = '/home/sidrees/scratch/RetinaPredictors/data/retina1/8ms/datasets/retina2_dataset_train_val_test_scotopic.h5'
mdl_name = 'CNN_2D'

path_excel = '/home/sidrees/scratch/RetinaPredictors/performance/retina2/'
path_perFiles = '/home/sidrees/scratch/RetinaPredictors/data/retina2/8ms/pr_paramSearch'
...
csv_header = ['path_mdl','trainingDataset','testingDataset','mdl_name','path_excel','path_perFiles','r_sigma','r_phi','r_eta','r_k','r_h','r_beta','r_hillcoef','r_gamma']
...
for i in range(params_array.shape[0]):
    ...
    csv_data = [path_mdl,trainingDataset,testingDataset,mdl_name,path_excel,path_perFiles]
    csv_data.extend(rgb)
