...
# Train FC
ft_loss_epoch_train_A,ft_loss_epoch_val_A,ft_mdl_state,fev_epoch_train_A,fev_epoch_val_A,fev_epoch_test_A,lr_epoch,lr_step = maml.ft_train(
    ft_mdl_state,ft_params_fixed,config,ft_data_train,ft_data_val,ft_data_test,batch_size,ft_nb_epochs_A,ft_path_model_save,save=True,ft_lr_schedule=ft_lr_schedule_A)
...
ft_lr_schedule_B = optax.exponential_decay(init_value=1e-3,transition_steps=n_batches*3,decay_rate=0.75,staircase=True,transition_begin=0)    # NATSTIM
# ft_lr_schedule_B = optax.exponential_decay(init_value=1e-2,transition_steps=n_batches*1,decay_rate=0.5,staircase=True,transition_begin=0)
...
ft_loss_epoch_train_B,ft_loss_epoch_val_B,ft_mdl_state,fev_epoch_train_B,fev_epoch_val_B,fev_epoch_test_B,lr_epoch,lr_step = maml.ft_train(
    ft_mdl_state,ft_params_fixed,config,ft_data_train,ft_data_val,ft_data_test,batch_size,ft_nb_epochs_B,ft_path_model_save,save=True,ft_lr_schedule=ft_lr_schedule_B)
