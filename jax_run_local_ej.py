...
path_model_save_base = os.path.join(base,'analyses/data_'+data_pers+'/','models',subFold,expDate,dataset_nameForPaths,mdl_subFold)
...
# fname_data_train_val_test = os.path.join('/home/saad/postdoc_db/analyses/data_mike/20230725C/datasets/20230725C_dataset_train_val_test_NATSTIM3_CORR_mesopic-Rstar_spatResamp_f4_8ms.h5')
