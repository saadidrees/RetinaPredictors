...
pretrained_expDates = 'trainList_20241115a'
#('2018-03-01-4','2018-03-01-0','2018-02-09-3')
ft_expDate = '2015-10-29-2' #'2018-02-06-4' #'2015-10-29-2' #'2018-02-06-4'

APPROACH = 'metal'
expFold = 'cluster/'+APPROACH #'maml2'
